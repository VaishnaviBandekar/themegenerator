...
# Login to Hugging Face using token (from HF Spaces Secret)
login(token=os.getenv("HF_TOKEN"))

# Initialize Flask
app = Flask(__name__)

# Load the LLaMA model and tokenizer (Gemma-2B)
model_name = "google/gemma-2b"
tokenizer = AutoTokenizer.from_pretrained(model_name)
model = AutoModelForCausalLM.from_pretrained(model_name)

# Function to generate an event theme description
...
def generate_theme():
    ...
    # Generate the theme description
